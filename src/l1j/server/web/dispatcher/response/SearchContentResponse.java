...
public class SearchContentResponse extends HttpResponseModel {
	private static final KeyValuePair<String, String> SEARCH_CODE_PAIR = new KeyValuePair<String, String>("{SEARCH_CODE}",	"4");
	
	public SearchContentResponse() {}
	private SearchContentResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new SearchContentResponse(request, model);
	}
}
