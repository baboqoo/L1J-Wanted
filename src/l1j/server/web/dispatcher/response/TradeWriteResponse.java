...
public class TradeWriteResponse extends HttpResponseModel {
	...
	public TradeWriteResponse() {}
	private TradeWriteResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new TradeWriteResponse(request, model);
	}
}
