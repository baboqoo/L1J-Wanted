...
public class ContentModifyResponse extends HttpResponseModel {
	...
	private ContentModifyResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponse get_response() throws Exception {
		...
		ContentVO cur		= ContentDAO.getBoard(num);
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new ContentModifyResponse(request, model);
	}
