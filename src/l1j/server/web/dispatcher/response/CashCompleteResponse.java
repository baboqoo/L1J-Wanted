...
public class CashCompleteResponse extends HttpResponseModel {
	public CashCompleteResponse() {}
	private CashCompleteResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponse get_response() throws Exception {
		...
		params.add(new KeyValuePair<String, String>("{PRICE}",	post.get("price")));
		params.add(new KeyValuePair<String, String>("{COUNT}",	post.get("count")));
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new CashCompleteResponse(request, model);
	}
}
