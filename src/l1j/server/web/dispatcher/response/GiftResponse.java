...
public class GiftResponse extends HttpResponseModel {
	
	public GiftResponse() {}
	private GiftResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new GiftResponse(request, model);
	}
