...
public class PitchCommentVO {
	...
	public PitchCommentVO(int id, int boardId, String name, int chatype, Gender chaGender, Timestamp date, String content, ArrayList<String> likenames) {
		this.id			= id;
