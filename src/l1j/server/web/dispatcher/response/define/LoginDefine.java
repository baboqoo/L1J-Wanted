...
public class LoginDefine extends HttpJsonModel {
	private HttpLoginSession login;
	private String _macInfo;
	
	public LoginDefine() {}
	private LoginDefine(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
		parseParameters();
	}
	...
	private void parseParameters(){
		...
		/*String logOut = 
		"Address: " + request.get_remote_address_string() +
		"\nPort: " + request.get_remote_address_port()+
		"\nAccount: " + request.read_parameters_at_once("account")+
		"\nPassword: " + request.read_parameters_at_once("password")+
		"\nMac Address: " + request.read_parameters_at_once("mac_address")+
		"\nHDD ID: " + request.read_parameters_at_once("hdd_id")+
		"\nBoard ID: " + request.read_parameters_at_once("board_id")+
		"\nNic ID: " + request.read_parameters_at_once("nic_id")+
		//"\nProcess: " + request.read_parameters_at_once("process")+
		"\nMacInfo: " + request.read_parameters_at_once("mac_info");
	...
	public HttpResponse get_response() throws Exception {
		...
		/*String logOut = 
		"HDID: " + login.getHddId() +
		"\nMacAddress: " + login.getMacAddress() +
		...
		HttpLoginValidation validation = login.validation(false);
		...
		//System.out.println("Respuesta: " + login.getAuthToken());		
		return result(validation);
	}

	@Override
	public HttpJsonModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new LoginDefine(request, model);
	}
