...
public class PowerbookWriteResponse extends HttpResponseModel {
	...
	public PowerbookWriteResponse() {}
	private PowerbookWriteResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new PowerbookWriteResponse(request, model);
	}
}
