...
public class TradeReceiveResponse extends HttpResponseModel {
	public TradeReceiveResponse() {}
	private TradeReceiveResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new TradeReceiveResponse(request, model);
	}
}
