...
public class ContentWriteResponse extends HttpResponseModel {
	...
	public ContentWriteResponse() {}
	private ContentWriteResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new ContentWriteResponse(request, model);
	}
