...
public class GuideWriteResponse extends HttpResponseModel {
	...
	public GuideWriteResponse() {}
	private GuideWriteResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new GuideWriteResponse(request, model);
	}
}
