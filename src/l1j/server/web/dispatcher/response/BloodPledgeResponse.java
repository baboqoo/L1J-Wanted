...
public class BloodPledgeResponse extends HttpResponseModel {
	...
	public BloodPledgeResponse() {}
	private BloodPledgeResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new BloodPledgeResponse(request, model);
	}
