...
public class BoardResponse extends HttpResponseModel {
	...
	private BoardResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponse get_response() throws Exception {
		...
		params.add(new KeyValuePair<String, String>("{TOTAL_SIZE}",			String.valueOf(BoardDAO._freeBoard.size())));
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new BoardResponse(request, model);
	}
