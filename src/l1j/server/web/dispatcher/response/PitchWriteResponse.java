...
public class PitchWriteResponse extends HttpResponseModel {
	...
	public PitchWriteResponse() {}
	private PitchWriteResponse(HttpRequestModel request, DispatcherModel model) {
		super(request, model);
	}
	...
	public HttpResponse get_response() throws Exception {
		...
		if (request.isIngame()) {
			...
			if (pc == null) {
				...
				return new AlertRedirectResponse(request, "Unable to find in-game character.", "/index").get_response();
			}
		}
	...
	public HttpResponseModel copyInstance(HttpRequestModel request, DispatcherModel model) throws Exception {
		return new PitchWriteResponse(request, model);
	}
}
