...
public class SpellCommonBin implements ProtoMessage {
	public static SpellCommonBin newInstance() {
		return new SpellCommonBin();
	}
	...
	public ProtoMessage readFrom(ProtoInputStream input) throws java.io.IOException {
		while (!input.isAtEnd()) {
			...
			default: {
				System.out.println(String.format("[SpellCommonBin] NEW_TAG : TAG(%d)", tag));
				return this;
			}
			}
		}
