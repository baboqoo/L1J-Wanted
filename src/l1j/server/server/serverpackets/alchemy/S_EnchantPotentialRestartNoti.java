...
public class S_EnchantPotentialRestartNoti extends ServerBasePacket {
	private static final String S_ENCHANT_POTENTIAL_RESTART_NOTI = "[S] S_EnchantPotentialRestartNoti";
	private byte[] _byte = null;
    public static final int RESTART_NOTI	= 0x094d;
    ...
    public S_EnchantPotentialRestartNoti(int target_id, int bonus_grade, int bonus_id, int curbonus_desc){
    	write_init();
	...
	public String getType() {
		return S_ENCHANT_POTENTIAL_RESTART_NOTI;
	}
}
