...
public class S_EventPushInfoListNoti extends ServerBasePacket {
	private static final String S_EVENT_PUSH_INFO_LIST_NOTI = "[S] S_EventPushInfoListNoti";
	private byte[] _byte = null;
	public static final int NOTI = 0x099e;
	
	public S_EventPushInfoListNoti(L1PcInstance pc, Collection<EventPushObject> tempList) {
		write_init();
	...
	public String getType() {
		return S_EVENT_PUSH_INFO_LIST_NOTI;
	}
}
