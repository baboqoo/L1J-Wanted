...
public class S_FreeBuffShieldInfo extends ServerBasePacket {
	private static final String S_FREE_BUFF_SHIELD_INFO = "[S] S_FreeBuffShieldInfo";
	private byte[] _byte = null;
	public static final int INFO	= 0x0ab7;
	
	public S_FreeBuffShieldInfo(FreeBuffShieldHandler handler) {
		write_init();
	...
	public String getType() {
		return S_FREE_BUFF_SHIELD_INFO;
	}
}
