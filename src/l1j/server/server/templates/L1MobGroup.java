...
public class L1MobGroup {
	...
	private int _minion8Id;
	private int _minion8Count;
	...
	public int getMinion8Id() {
		return _minion8Id;
	}

	public void setMinion8Id(int i) {
		_minion8Id = i;
	}
	
	public int getMinion8Count() {
		return _minion8Count;
	}

	public void setMinion8Count(int i) {
		_minion8Count = i;
	}
}
