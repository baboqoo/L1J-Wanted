...
public class A_TimeCollectionSelectBonus extends ProtoHandler {
	protected A_TimeCollectionSelectBonus(){}
	private A_TimeCollectionSelectBonus(byte[] data, GameClient client) {
		super(data, client);
	}
	...
	protected void doWork() throws Exception {
		...
		if (collection == null) {
			System.out.println(String.format(
					"[A_TimeCollectionSelectBonus] NOT_COLLECTION : GROUP(%d), ID(%d), NAME(%s)", 
	...
	protected ProtoHandler copyInstance(byte[] data, GameClient client) {
		return new A_TimeCollectionSelectBonus(data, client);
	}
