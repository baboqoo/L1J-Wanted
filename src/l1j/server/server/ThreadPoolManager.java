...
public class ThreadPoolManager {
	...
	private ThreadPoolManager() {
		_effectsScheduledThreadPool = new ScheduledThreadPoolExecutor(Config.SERVER.THREAD_P_EFFECTS, new PriorityThreadFactory("EffectsSTPool", Thread.MIN_PRIORITY));
		_generalScheduledThreadPool = new ScheduledThreadPoolExecutor(Config.SERVER.THREAD_P_GENERAL, new PriorityThreadFactory("GerenalSTPool", Thread.NORM_PRIORITY));
		...
		// will be really used in the next AI implementation.
		_aiThreadPool = new ThreadPoolExecutor(1, Config.SERVER.AI_MAX_THREAD, 10L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>());
		_aiScheduledThreadPool = new ScheduledThreadPoolExecutor(Config.SERVER.AI_MAX_THREAD, new PriorityThreadFactory("AISTPool", Thread.NORM_PRIORITY));
	}
	...
	public String[] getStats() {
		return new String[] {
				...
				" |- ScheduledTasks:  "
						+ (_effectsScheduledThreadPool.getTaskCount() - _effectsScheduledThreadPool.getCompletedTaskCount()),
				" | -------",
				" + General:",
				...
				" |- ScheduledTasks:  "
						+ (_aiScheduledThreadPool.getTaskCount() - _aiScheduledThreadPool.getCompletedTaskCount()), "TP:",
