...
public class InfamousBarlogAction implements L1NpcIdAction {
	private static class newInstance {
		public static final L1NpcIdAction INSTANCE = new InfamousBarlogAction();
	}
	public static L1NpcIdAction getInstance(){
		return newInstance.INSTANCE;
	}
	private InfamousBarlogAction(){}
	
	@Override
	public String excute(L1PcInstance pc, String s, String s2, L1Object obj, int npcId) {
		L1NpcInstance npc = (L1NpcInstance) obj;
		if (pc.getKarma() <= -10000000) {
			karmaBarlogIncrease(pc, npc, s);
		}
		return StringUtil.EmptyString;
	}
	
	private void karmaBarlogIncrease(L1PcInstance pc, L1NpcInstance npc, String s) {
		...
		if (item != null) {
			...
			pc.sendPackets(L1ServerMessage.sm1081);
		}
	}
}
