...
public class TrollNbmorphAction implements L1NpcHtmlAction {
	private static class newInstance {
		public static final L1NpcHtmlAction INSTANCE = new TrollNbmorphAction();
	}
	public static L1NpcHtmlAction getInstance(){
		return newInstance.INSTANCE;
	}
	private TrollNbmorphAction(){}

	@Override
	public String excute(L1PcInstance pc, String s, String s2, L1Object obj, int npcId) {
		if (pc.getLevel() < 13) {
			if (pc.getInventory().consumeItem(L1ItemId.ADENA, 100)) {
				L1PolyMorph.poly(pc, 3878);
			} else {
