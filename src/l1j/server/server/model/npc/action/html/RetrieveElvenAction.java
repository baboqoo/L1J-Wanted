...
public class RetrieveElvenAction implements L1NpcHtmlAction {
	private static class newInstance {
		public static final L1NpcHtmlAction INSTANCE = new RetrieveElvenAction();
	}
	public static L1NpcHtmlAction getInstance(){
		return newInstance.INSTANCE;
	}
	private RetrieveElvenAction(){}
	...
	public String excute(L1PcInstance pc, String s, String s2, L1Object obj, int npcId) {
		...
		if (pc.getLevel() >= 5 && pc.isElf()) {
			...
			S_WareHouseItemListNoti rpl = new S_WareHouseItemListNoti(S_WareHouseItemListNoti.eWarehouseType.TRADE_RETRIEVE_ELVEN, npc, pc);
			if (rpl.is_non_value) {
