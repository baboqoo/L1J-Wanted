...
public class RetrieveCharAction implements L1NpcHtmlAction {
	private static class newInstance {
		public static final L1NpcHtmlAction INSTANCE = new RetrieveCharAction();
	}
	public static L1NpcHtmlAction getInstance(){
		return newInstance.INSTANCE;
	}
	private RetrieveCharAction(){}
	...
	public String excute(L1PcInstance pc, String s, String s2, L1Object obj, int npcId) {
		...
		if (pc.getSpecialWareHouseSize() > 0) {
			...
			S_WareHouseItemListNoti rpl = new S_WareHouseItemListNoti(S_WareHouseItemListNoti.eWarehouseType.TRADE_RETRIEVE_CHAR, npc, pc);
			if (rpl.is_non_value) {
