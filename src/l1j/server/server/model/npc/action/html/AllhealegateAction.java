...
public class AllhealegateAction implements L1NpcHtmlAction {
	private static class newInstance {
		public static final L1NpcHtmlAction INSTANCE = new AllhealegateAction();
	}
	public static L1NpcHtmlAction getInstance(){
		return newInstance.INSTANCE;
	}
	private AllhealegateAction(){}

	@Override
	public String excute(L1PcInstance pc, String s, String s2, L1Object obj, int npcId) {
		castleDoorRepair(pc, 2001, 1);
		castleDoorRepair(pc, 2002, 1);
		castleDoorRepair(pc, 2003, 1);
		return null;
	}
