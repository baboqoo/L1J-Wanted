...
public class HealegateGiranInnerGate1Action implements L1NpcHtmlAction {
	private static class newInstance {
		public static final L1NpcHtmlAction INSTANCE = new HealegateGiranInnerGate1Action();
	}
	public static L1NpcHtmlAction getInstance(){
		return newInstance.INSTANCE;
	}
	private HealegateGiranInnerGate1Action(){}
