...
public class PhysicalEnchantDex extends L1SkillActionHandler {
	...
	public int start(L1Character attacker, L1Character cha, int time, L1Magic magic) {
		...
		if (cha instanceof L1PcInstance) {
			...
			pc.sendPackets(new S_Dexup(pc, 5, time), true);
		}
		return 0;
	}
	...
	public L1SkillActionHandler copyInstance() {
		return new PhysicalEnchantDex().setValue(_skillId, _skill);
	}
