...
public class IceLance extends L1SkillActionHandler {

	@Override
	public int start(L1Character attacker, L1Character cha, int time, L1Magic magic) {
		boolean isFreeze = magic.calcProbabilityMagic(_skillId);
		if (isFreeze) {
			...
			L1EffectSpawn.getInstance().spawnEffect(81168, duration, cha.getX(), cha.getY(), cha.getMapId());
	...
	public L1SkillActionHandler copyInstance() {
		return new IceLance().setValue(_skillId, _skill);
	}
