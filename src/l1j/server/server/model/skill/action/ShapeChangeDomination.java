...
public class ShapeChangeDomination extends L1SkillActionHandler {
	...
	public void stop(L1Character cha) {
		...
		cha.getAbility().addAddedCha((byte) -1);
		cha.addMaxHp(-200);
	}
	...
	public L1SkillActionHandler copyInstance() {
		return new ShapeChangeDomination().setValue(_skillId, _skill);
	}
