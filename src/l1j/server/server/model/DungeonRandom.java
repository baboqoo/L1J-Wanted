...
public class DungeonRandom {
	...
	private static final Map<String, NewDungeonRandom> _dungeonMap = new HashMap<String, NewDungeonRandom>();
	...
	public static boolean dg(String key, L1PcInstance pc) {
		if (_dungeonMap.containsKey(key)) {
			...
			pc.getTeleport().start(newX, newY, newMap, heading, true);
			return true;
		}
		return false;
	}
