...
public class ActionCodes {
	...
	public static final int ACTION_Idle_TWO				=	9;
	...
	public static final int ACTION_AltAttackAxe			=	74;
	public static final int ACTION_AltAttackBow			=	75;
	...
	public static final int ACTION_DoubleAxeWalk		=	88;
	public static final int ACTION_DoubleAxeAttack		=	89;
	public static final int ACTION_DoubleAxeDamage		=	90;
	public static final int ACTION_DoubleAxeIdle		=	91;
	
	public static final int ACTION_Enchant				=	95;
	public static final int ACTION_Enchant_Success		=	96;
	public static final int ACTION_Enchant_faiure		=	97;
	
	public static final int ACTION_WalkSpear			=	121;
	public static final int ACTION_AttackSpear			=	122;
	public static final int ACTION_DamageSpear			=	123;
	public static final int ACTION_BreathSpear			=	124;
	public static final int ACTION_AltAttackSpear		=	125;
}
